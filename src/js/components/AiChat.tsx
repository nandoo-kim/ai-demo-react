...
// ✅ 질문 실행
	...
	useEffect(() => {
		//const apiKey = import.meta.env.VITE_OPENAI_API_KEY;
		//const googleApiKey = import.meta.env.VITE_GOOGLE_API_KEY;
		console.log(aiRef.current);

		aiRef.current.settings.openaiApiKey = import.meta.env.VITE_OPENAI_API_KEY;
		aiRef.current.settings.geminiApiKey = import.meta.env.VITE_GEMINI_API_KEY;

		aiRef.current.settings.ollamaUrl = import.meta.env.VITE_OLLAMA_URL;
	}, []);

	return (
		<nx-ai-container ref={aiRef} className="collapse"></nx-ai-container>
	);
